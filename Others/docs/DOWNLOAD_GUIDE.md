...
<img src="./images/win01.png" alt="Windows 安装界面 1" width="520" />
<img src="./images/win02.png" alt="Windows 安装界面 2" width="520" />

## 3. macOS 安装步骤

1. 双击下载的 `DigitMaid-macos-apple-silicon.dmg`。
2. 在打开的安装窗口中，将 `DigitMaid.app` 拖入 `Applications`（应用程序）文件夹。
<img src="./images/mac01.png" alt="macOS 安装界面" width="520" />
...
- “无法验证开发者”
- “Apple 无法检查其是否包含恶意软件”
<img src="./images/mac02.png" alt="macOS 拦截提示" width="460" />
请按下面步骤在“隐私与安全性”中放行：

1. 打开“系统设置” -> “隐私与安全性”。
2. 向下滚动到“安全性”区域。
3. 看到“DigitMaid.app 已被阻止使用”后，点击“仍要打开”。
<img src="./images/mac03.png" alt="隐私与安全性允许打开" width="620" />
